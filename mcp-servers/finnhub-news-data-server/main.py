...
def get_finnhub_news(ticker: str, start_date: str, end_date: str) -> str:
    ...
    """
    try:
        params = FinnhubNewsParameters(ticker=ticker, start_date=start_date, end_date=end_date)
        ...
        finnhub_news_result = finnhub_news.get_news(params.ticker, params.end_date, look_back_days)
