...
class InvestmentManager:
    ...
    async def execute_analysis_phase(self, ticker: str, date: str = None) -> str:
        ...
        logging.info(f"=== PHASE 1: ANALYSIS - Completed ===")
    ...
    async def execute_research_phase(self, query: str) -> str:
        ...
        logging.info(f"=== PHASE 2: RESEARCH - Completed ===")
        return f"Research phase completed. Investment plan and recommendation generated."
    ...
    async def execute_trading_phase(self, query: str) -> str:
        ...
        logging.info(f"=== PHASE 3: TRADING - Completed ===")
        return f"Trading phase completed. Execution plan with risk parameters generated."
    ...
    async def make_execution_decision(self, review_decision: bool = True) -> str:
        ...
        if "BUY" in decision_upper and "SELL" not in decision_upper[:decision_upper.find("BUY")+10]:
            action = "BUY"
