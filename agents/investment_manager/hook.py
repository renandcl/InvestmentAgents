...
class SharedDocument:
    ...
    def get_shared_document(self, event: BeforeInvocationEvent) -> None:
        ...
        try:
            ...
            event.shared_document = {
                ...
                "final_trade_decision": final_trade_decision[:500]
    ...
    def save_shared_document(self, event: AfterInvocationEvent) -> None:
        ...
        try:
            ...
            if (
                "execution decision" in response_text.lower()
                or "execution_action" in response_text.lower()
            ):
                ...
                logger.info(
                    f"Saved execution decision: {shared_document.get('execution_action')}"
                )
