...
class SharedStateHandler(HookProvider):
    ...
    def get_shared_state(self, event: BeforeInvocationEvent):
        ...
        investment_plan = shared_state.get("investment_plan", "No investment plan provided")
        judge_decision = shared_state.get("judge_decision", "No decision provided")
    ...
    def save_shared_state(self, event: AfterInvocationEvent):
        ...
        shared_state["trader_investment_plan"] = message
        shared_state["trader_decision"] = message
...
Investment Plan: {shared_state.get('investment_plan')}
        """.strip()
